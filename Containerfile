...
# Eighteen extensions, against the ~70 in upstream's default static build. gd,
...
ARG PHP_EXTENSIONS="dom,pdo,pdo_sqlite,sqlite3,zlib,mbstring,mbregex,iconv,session,xml,simplexml,filter,tokenizer,ctype,pcntl,posix,opcache,openssl"
